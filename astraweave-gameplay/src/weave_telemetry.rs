...
impl WeaveTelemetry {
    pub fn add_terrain(&mut self, cost: i32) { self.ops_applied += 1; self.terrain_cost += cost; }
    pub fn add_weather(&mut self, cost: i32) { self.ops_applied += 1; self.weather_cost += cost; }
}
