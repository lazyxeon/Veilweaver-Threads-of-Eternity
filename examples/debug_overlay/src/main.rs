use eframe::egui;
use astraweave_core::{IVec2, World, Team, WorldSnapshot, PlayerState, CompanionState, EnemyState, PlanIntent, ActionStep};
...
impl App {
    fn new() -> Self {
        ...
        // wall
        for y in 1..=8 { world.obstacles.insert((6,y)); }
        ...
        let plan = Some(PlanIntent {
            ...
            steps: vec![
                ...
                ActionStep::Throw { item:"smoke".into(), x:7, y:2 },
                ActionStep::CoverFire { target_id:enemy, duration:2.0 },
            ]
        });
        Self { grid_w: 20, grid_h: 10, world, player, comp, enemy, plan }
    }
}
    ...
    fn update(&mut self, ctx:&egui::Context, _frame: &mut eframe::Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            let to_screen = |p:IVec2| -> egui::Pos2 {
                egui::pos2(rect.left() + p.x as f32 * cell_w, rect.top() + p.y as f32 * cell_h)
            };
            ...
            for (x,y) in self.world.obstacles.iter() {
                let r = egui::Rect::from_min_size(
                    egui::pos2(rect.left()+ *x as f32 * cell_w, rect.top()+ *y as f32 * cell_h),
                ...
                for step in &plan.steps {
                    match step {
                        ...
                        ActionStep::Throw{item:_,x,y} => {
                            ...
                            shapes.push(egui::Shape::circle_stroke(to_screen(tgt), 6.0, egui::Stroke::new(2.0, egui::Color32::GOLD)));
                        }
                        ActionStep::CoverFire{target_id:_, duration:_} => {
...
fn main() -> eframe::Result<()> {
    ...
    eframe::run_native("AstraWeave Debug Overlay", native, Box::new(|_| Box::new(App::new())))
}
