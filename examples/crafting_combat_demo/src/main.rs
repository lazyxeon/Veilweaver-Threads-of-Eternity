...
fn main() -> anyhow::Result<()> {
    ...
    let mut node = harvesting::ResourceNode {
    ...
    let echo = EchoMod {
        name: "Wind‑sung".into(),
        power_mult: 1.35,
        dtype_override: Some(DamageType::Echo),
        special: None,
    };
    ...
    let mut player = Stats::new(120);
    player.power = 8;
    let mut enemy = Stats::new(100);
    enemy.defense = 4;
